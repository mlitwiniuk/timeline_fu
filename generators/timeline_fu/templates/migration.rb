class CreateTimelineEvents < ActiveRecord::Migration
  def self.up
    create_table :timeline_events do |t|
      ...
      t.string   :event_type, :subject_type,  :actor_type,  :secondary_subject_type,  :scope_type
      t.integer               :subject_id,    :actor_id,    :secondary_subject_id,    :scope_id
      t.timestamps
    end
    ...
    add_index :timeline_events, [:scope_id , :scope_type], :name => 'scoped_timeline_events'
  end
